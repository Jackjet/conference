...
namespace ConferenceModel.FileSyncAppPoolWebService {
    ...
    public interface FileSyncAppPoolWebserviceSoap {
        ...
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        ConferenceModel.FileSyncAppPoolWebService.FileSyncAppEntity GetSyncServiceData(string conferenceName);
        
        [System.ServiceModel.OperationContractAttribute(AsyncPattern=true, Action="http://tempuri.org/GetSyncServiceData", ReplyAction="*")]
        System.IAsyncResult BeginGetSyncServiceData(string conferenceName, System.AsyncCallback callback, object asyncState);
    ...
    public partial class FillSyncServiceDataRequest {
        ...
        public FillSyncServiceDataRequest(string conferenceName, byte[] bytesStr) {
    ...
    public partial class FileSyncAppPoolWebserviceSoapClient : System.ServiceModel.ClientBase<ConferenceModel.FileSyncAppPoolWebService.FileSyncAppPoolWebserviceSoap>, ConferenceModel.FileSyncAppPoolWebService.FileSyncAppPoolWebserviceSoap {
        ...
        public void FillSyncServiceData(string conferenceName, byte[] bytesStr) {
            ...
            inValue.conferenceName = conferenceName;
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public System.IAsyncResult BeginFillSyncServiceData(string conferenceName, byte[] bytesStr, System.AsyncCallback callback, object asyncState) {
            ConferenceModel.FileSyncAppPoolWebService.FillSyncServiceDataRequest inValue = new ConferenceModel.FileSyncAppPoolWebService.FillSyncServiceDataRequest();
            inValue.conferenceName = conferenceName;
            inValue.bytesStr = bytesStr;
        ...
        private System.IAsyncResult OnBeginFillSyncServiceData(object[] inValues, System.AsyncCallback callback, object asyncState) {
            ...
            return this.BeginFillSyncServiceData(conferenceName, bytesStr, callback, asyncState);
        }
        ...
        public void FillSyncServiceDataAsync(string conferenceName, byte[] bytesStr) {
            this.FillSyncServiceDataAsync(conferenceName, bytesStr, null);
        }
        
        public void FillSyncServiceDataAsync(string conferenceName, byte[] bytesStr, object userState) {
        ...
        public ConferenceModel.FileSyncAppPoolWebService.FileSyncAppEntity GetSyncServiceData(string conferenceName) {
            return base.Channel.GetSyncServiceData(conferenceName);
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        public System.IAsyncResult BeginGetSyncServiceData(string conferenceName, System.AsyncCallback callback, object asyncState) {
            return base.Channel.BeginGetSyncServiceData(conferenceName, callback, asyncState);
        }
        ...
        private System.IAsyncResult OnBeginGetSyncServiceData(object[] inValues, System.AsyncCallback callback, object asyncState) {
            string conferenceName = ((string)(inValues[0]));
            return this.BeginGetSyncServiceData(conferenceName, callback, asyncState);
        }
        ...
        public void GetSyncServiceDataAsync(string conferenceName) {
            this.GetSyncServiceDataAsync(conferenceName, null);
        }
        
        public void GetSyncServiceDataAsync(string conferenceName, object userState) {
            ...
            base.InvokeAsync(this.onBeginGetSyncServiceDataDelegate, new object[] {
                        conferenceName}, this.onEndGetSyncServiceDataDelegate, this.onGetSyncServiceDataCompletedDelegate, userState);
        }
    }
}
