...
namespace ConferenceCommon.SharePointHelper
{
    ...
    public class ClientContextManage
    {
        ...
        public void CreateClient(string webSiteUrl, string userName, string passWord, string doMain)
        {
            try
            {
        ...
        public void LoadMethod(SP.ClientObject obj)
        {
            try
            {
                if (ClientContext != null)
