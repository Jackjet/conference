...
namespace Conference_Space
{
    ...
    public partial class UCBook : Grid, INotifyPropertyChanged
    {
        ...
        public delegate void DeleteFileEventHandle(UCBook ucbook);
        /// <summary>
        /// 删除文件事件
        /// </summary>
        public event DeleteFileEventHandle DeleteFile = null;

        public delegate void ShareFileEventHandle(string uri, FileType fileType);
        /// <summary>
        /// 文件共享事件
        /// </summary>
        public event ShareFileEventHandle ShareFile = null;

        /// <summary>
        /// 文件共享事件
        /// </summary>
        public event ShareFileEventHandle RealShareFile = null;

        public delegate void DownLoadFileEventHandle(string uri);
        /// <summary>
        /// 下载文件事件
        /// </summary>
        public event DownLoadFileEventHandle DownLoadFile = null;
        ...
        ConferenceWebCommon.EntityHelper.ConferenceOffice.FileType fileType;
        /// <summary>
        /// 文件类型
        /// </summary>
        public ConferenceWebCommon.EntityHelper.ConferenceOffice.FileType FileType
        {
            get { return fileType; }
            set
            {
        ...
        public void menuItemShare()
        {
            try
            {
                ...
                {
                    this.ShareFile(this.Uri, this.FileType);
                }
            }
            catch (Exception ex)
            {
        ...
        public void menuItemRealTimeShare()
        {
            ...
            {
                //激发文件共享事件
                if (this.RealShareFile != null)
                {
                    this.RealShareFile(this.Uri, this.FileType);
                }
            }
            catch (Exception ex)
            {
