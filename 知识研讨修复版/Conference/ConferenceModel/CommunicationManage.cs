...
namespace ConferenceModel
{
    public class CommunicationManage
    {
        ...
        /// 获取服务器所传送的数据
        /// </summary>
        public Action<ConferenceWebCommon.Common.PackageBase> clientSocket_TCPDataArrivalCallBack;
        ...
        public void GetServicePort(Action callBack)
        {
            ...
            {
                //获取知识树服务端口
                ModelManage.ConferenceInfo.GetMeetPort(CommunicationCodeEnterEntity.ConferenceName, ConferenceModel.ConferenceInfoWebService.ConferenceClientAcceptType.ConferenceTree, new Action<bool, ConferenceModel.ConferenceInfoWebService.PortTypeEntity>((Successed, MeetPort) =>
                {
                }));

                //获取语音服务端口
                ModelManage.ConferenceInfo.GetMeetPort(CommunicationCodeEnterEntity.ConferenceName, ConferenceModel.ConferenceInfoWebService.ConferenceClientAcceptType.ConferenceAudio, new Action<bool, ConferenceModel.ConferenceInfoWebService.PortTypeEntity>((Successed, MeetPort) =>
                {
                }));

                //获取消息服务端口
                ModelManage.ConferenceInfo.GetMeetPort(CommunicationCodeEnterEntity.ConferenceName, ConferenceModel.ConferenceInfoWebService.ConferenceClientAcceptType.ConferenceInfoSync, new Action<bool, ConferenceModel.ConferenceInfoWebService.PortTypeEntity>((Successed, MeetPort) =>
                {
                }));

                //获取lync服务端口
                ModelManage.ConferenceInfo.GetMeetPort(CommunicationCodeEnterEntity.ConferenceName, ConferenceModel.ConferenceInfoWebService.ConferenceClientAcceptType.LyncConversationSync, new Action<bool, ConferenceModel.ConferenceInfoWebService.PortTypeEntity>((Successed, MeetPort) =>
                {

                }));

                //获取智存空间服务端口
                ModelManage.ConferenceInfo.GetMeetPort(CommunicationCodeEnterEntity.ConferenceName, ConferenceModel.ConferenceInfoWebService.ConferenceClientAcceptType.ConferenceSpaceSync, new Action<bool, ConferenceModel.ConferenceInfoWebService.PortTypeEntity>((Successed, MeetPort) =>
                {

                }));

                //获取矩阵服务端口
                ModelManage.ConferenceInfo.GetMeetPort(CommunicationCodeEnterEntity.ConferenceName, ConferenceModel.ConferenceInfoWebService.ConferenceClientAcceptType.ConferenceMatrixSync, new Action<bool, ConferenceModel.ConferenceInfoWebService.PortTypeEntity>((Successed, MeetPort) =>
                {

                }));

                //获取文件服务端口【甩屏】
                ModelManage.ConferenceInfo.GetMeetPort(CommunicationCodeEnterEntity.ConferenceName, ConferenceModel.ConferenceInfoWebService.ConferenceClientAcceptType.ConferenceFileSync, new Action<bool, ConferenceModel.ConferenceInfoWebService.PortTypeEntity>((Successed, portTypeEntity) =>
                {
                    //调用成功
                    if (Successed)
                    {
        ...
        public void Repair_ClientSocket(ClientSocket clientSocket, ConferenceClientAcceptType conferenceClientAcceptType, bool NeedReflesh)
        {
            try
            {
                if (clientSocket != null && clientSocket._clientSocket != null)
                {
                    ...
                    {
                        //移除知识树通讯节点
                        ModelManage.ConferenceInfo.RemoveSelfClientSocket(CommunicationCodeEnterEntity.ConferenceName, conferenceClientAcceptType, CommunicationCodeEnterEntity.SelfUri, null);
                        //获取知识树服务端口
                        ModelManage.ConferenceInfo.GetMeetPort(CommunicationCodeEnterEntity.ConferenceName, conferenceClientAcceptType, new Action<bool, PortTypeEntity>((Successed, portTypeEntity) =>
                        {
                            //通知服务端进行套接字的收集
