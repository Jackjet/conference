...
namespace ConferenceModel.Common
{
    public class ClientSocket
    {
        ...
        public Action<ConferenceWebCommon.Common.PackageBase> TCPDataArrivalCallBack = null;
        ...
        public void SendRemoteData(ConferenceWebCommon.Common.ConferenceClientAccept conferenceClientAccept)
        {
            try
            {
