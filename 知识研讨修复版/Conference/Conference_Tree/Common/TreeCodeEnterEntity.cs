...
namespace Conference_Tree
{
    public static class TreeCodeEnterEntity
    {
        ...
        /// 个人空间列表
        /// </summary>
        internal static List<SP.Folder> mettingF = null;
        ...
        /// 当前打开的文件uri地址
        /// </summary>
        internal static string currentFileUri = null;

       /// <summary>
       /// 当前文件类型
       /// </summary>
        internal static wpfHelperFileType currentFileType = default(wpfHelperFileType);

        /// <summary>
        /// 知识树左侧内容类型
        /// </summary>
        internal static Tree_LeftContentType Tree_LeftContentType = Tree_LeftContentType.Summary;
